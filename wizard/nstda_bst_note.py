...
#         self.pool.get('nstda.bst.stock').bst_dbill_success(cr, uid, ids, context=context)
    ...
    def bst_send_approval(self, cr, uid, ids, context=None):
        model_obj = self.pool.get('nstda.bst.hbill').bst_send_approval(cr, uid, context['bst_id'], context=context)
    ...
    def bst_submit_approval(self, cr, uid, ids, context=None):   
        model_obj = self.pool.get('nstda.bst.hbill').bst_submit_approval(cr, uid, context['bst_id'], context=context) 
        
        
    def bst_submit_pick(self, cr, uid, ids, context=None):    
        model_obj = self.pool.get('nstda.bst.hbill').bst_submit_pick(cr, uid, context['bst_id'], context=context)
